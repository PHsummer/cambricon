...
function print_log() {
  echo -e "\033[31m ERROR: Please execute the command: cd cair_modelzoo/GPU/tools/mlu_performance_check; sudo bash set_mlu_perf.sh\033[0m"
}
...
FindMLUPID
[[ $? -eq 0 ]] && echo -e "\033[32m Check MLU Process Success! \033[0m" || exit
checkCPUPerfMode
