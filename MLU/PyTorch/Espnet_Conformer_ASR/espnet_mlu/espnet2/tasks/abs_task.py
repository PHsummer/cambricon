...
class AbsTask(ABC):
    ...
    def main_worker(cls, args: argparse.Namespace):
        ...
        model = model.to(
            ...
            device="mlu" if args.ngpu > 0 else "cpu",
        )
        ...
        if args.dry_run:
            ...
            for p in args.init_param:
                ...
                load_pretrained_model(
                    ...
                    # NOTE(kamo): "mlu" for torch.load always indicates mlu:0
                    #   in PyTorch<=1.4
                    map_location=f"mlu:{torch.mlu.current_device()}"
                    if args.ngpu > 0
                    else "cpu",
                )
    ...
    def build_model_from_file(
        ...
        Args:
            ...
            device: Device type, "cpu", "mlu", or "mlu:N".
