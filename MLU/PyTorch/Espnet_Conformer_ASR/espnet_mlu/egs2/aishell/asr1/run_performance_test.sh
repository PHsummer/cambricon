...
lm_log_path=exp/lm_train_lm_transformer_zh_char_max_epoch1_num_iters_per_epoch200/train.log
...
asr_log_path=exp/asr_train_asr_conformer_mlu_raw_zh_char_max_epoch1_num_iters_per_epoch200_sp/train.log
