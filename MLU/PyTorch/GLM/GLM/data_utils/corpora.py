...
class Pile(PromptReader):
    is_json = True
    PATH = os.getenv("PILE_DATASET_PATH") if os.getenv("PILE_DATASET_PATH") is not None else "/mnt/train"
...
class BertBaseData(BertData):
    ...
    #PATH = '/data/cpm/glm/glm-data'
    PATH = '/data/cpm/glm/wikipedia_and_bookcorpus'
