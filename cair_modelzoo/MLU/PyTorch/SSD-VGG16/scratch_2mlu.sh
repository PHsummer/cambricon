...
export MLU_VISIBLE_DEVICES=2,3

cmd="python train.py --dataset_root ${PYTORCH_TRAIN_DATASET}/VOCdevkit --save_folder ${PYTORCH_TRAIN_CHECKPOINT}/ssd_vgg16/basenet/ --dataset VOC --seed 42 --iters 60000 --device mlu --multiprocessing-distributed --world-size 1 --rank 0 --batch_size 64 --lr 2e-3 --dist-backend cncl --dist_url 'tcp://127.0.0.10:28502'"
