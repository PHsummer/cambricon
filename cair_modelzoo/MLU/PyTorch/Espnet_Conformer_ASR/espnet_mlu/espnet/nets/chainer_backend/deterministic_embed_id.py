...
from chainer import mlu, function_node, link, variable
...
class EmbedIDFunction(function_node.FunctionNode):
    ...
    def forward(self, inputs):
        ...
        xp = mlu.get_array_module(*inputs)
        if chainer.is_debug():
...
class EmbedIDGrad(function_node.FunctionNode):
    ...
    def forward(self, inputs):
        ...
        if xp is numpy:
            ...
            """
            # original code based on mlu elementwise method
