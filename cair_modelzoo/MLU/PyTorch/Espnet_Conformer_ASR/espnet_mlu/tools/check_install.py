...
def main():
    ...
    try:
        ...
        if torch.mlu.is_available():
            print(f"[x] torch mlu={torch.version.mlu}")
        else:
            print("[ ] torch mlu")
        ...
        if torch.distributed.is_cncl_available():
            print("[x] torch cncl")
        else:
            print("[ ] torch cncl")
    ...
    try:
        ...
        if chainer.backends.mlu.available:
            print("[x] chainer mlu")
        else:
            print("[ ] chainer mlu")

        if chainer.backends.mlu.cudnn_enabled:
    ...
    try:
        ...
        try:
            from cupy.mlu import cncl  # NOQA
