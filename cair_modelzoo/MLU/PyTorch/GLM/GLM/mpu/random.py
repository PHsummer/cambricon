...
def see_memory_usage(message, force=False):
    ...
    if dist.get_rank() == 0:
        print(message)
        if USE_MLU:
            print("Memory Allocated ", round(ct.memory_allocated()/(1024*1024*1024), 2), "GigaBytes")
            print("Max Memory Allocated ", round(ct.max_memory_allocated()/(1024*1024*1024), 2), "GigaBytes")
            print("Cache Allocated ", round(ct.memory_cached()/(1024*1024*1024), 2), "GigaBytes")
            print("Max cache Allocated ", round(ct.max_memory_cached()/(1024*1024*1024), 2), "GigaBytes")
        else:
...
class CheckpointFunction(torch.autograd.Function):
    ...
    def forward(ctx, run_function, *args):
        ...
        if USE_MLU:
            # print("WARNING: mlu does not support get rng_state1")
            pass
        else:
    ...
    def backward(ctx, *args):
        ...
        if USE_MLU:
            # print("WARNING: mlu does not support get rng_state")
            pass
        else:
