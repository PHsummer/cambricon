...
python -m torch.distributed.launch --nproc_per_node=1 \
	./run_pretraining.py --train_batch_size=20 --learning_rate=2e-4 --opt_lamb_beta_1=0.9 --opt_lamb_beta_2=0.999 \
	--warmup_proportion=0.0 --warmup_steps=0.0 --start_warmup_step=0 --max_steps=200 --phase2 --max_seq_length=512 --max_predictions_per_seq=76 \
