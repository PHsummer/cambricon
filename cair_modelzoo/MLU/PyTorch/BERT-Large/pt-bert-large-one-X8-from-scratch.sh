...
export MY_CONTAINER="test_pytorch_bert-large-1card"
...
docker exec -it $MY_CONTAINER bash -c "source /torch/venv3/pytorch/bin/activate && bash x8-1card-from-scratch.sh"
